...
exports.CodeGenProvider = void 0;
const vscode = __importStar(require("vscode"));
const getNonce_1 = require("./getNonce");
const AIService_1 = require("./ai/AIService");
const FileManager_1 = require("./core/FileManager");
const TerminalManager_1 = require("./core/TerminalManager");
class CodeGenProvider {
    constructor(_extensionUri) {
        this._extensionUri = _extensionUri;
        this._messageHistory = [];
        this._aiService = new AIService_1.AIService(AIService_1.AIService.getDefaultConfig());
        this._fileManager = new FileManager_1.FileManager();
        this._terminalManager = new TerminalManager_1.TerminalManager();
    }
    ...
    async handleUserMessage(text) {
        ...
        this._aiService.updateConfig(AIService_1.AIService.getDefaultConfig());
        const config = AIService_1.AIService.getDefaultConfig();
    ...
    sendSettings() {
        ...
        this.sendMessage({
            ...
            settings: {
                ...
                enableKnowledgeGraph: config.get('enableKnowledgeGraph') || true,
...
exports.CodeGenProvider = CodeGenProvider;
CodeGenProvider.viewType = 'codegen.sidebarProvider';
//# sourceMappingURL=CodeGenProvider.js.map